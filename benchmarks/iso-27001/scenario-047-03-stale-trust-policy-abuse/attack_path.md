# Caminho do Ataque: 03 Stale Trust Policy Abuse
...
graph TD
    ...
    A[Access Key Abandonada]:::attacker -->|Acesso via CLI| B(Recursos Core):::target
    B --> C{Abuso de Conta Sem Rotação}:::impact
```
