# Caminho do Ataque: 10 Default Sg Lateral Movement
...
graph TD
    ...
    A[Instância Bastion Pública]:::attacker -->|Acesso SSH Trânsitivo| B(Banco de Dados Interno):::target
    B --> C{Movimentação Lateral}:::impact
```
